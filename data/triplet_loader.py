...
class TripletFolder(torch.utils.data.Dataset):
	def __init__(self, root, transform = None, target_transform = None, loader = default_loader):
		...
		self.triplets = pd.read_table(root+'/Anno/triplet_train.txt',sep="\s+")[['anchor', 'positive', 'negative']].values

		self.data_vis_loc = pd.read_table(root+'/Anno/list_landmarks_inshop.txt',sep="\s+")[[
